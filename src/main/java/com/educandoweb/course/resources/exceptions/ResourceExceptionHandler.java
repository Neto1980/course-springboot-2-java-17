...
public class ResourceExceptionHandler {
	...
	@ExceptionHandler(DatabaseException.class) // Essa antotation serve para indicar que o método abaixo intercept qualquer exceção do "ResourceNotFoundException".
